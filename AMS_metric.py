...
def create_solution_dictionary(solution='training_solutions.csv'):
...
def AMS_metric(submission, solution='training_solutions.csv'):
    ...
    numEvents = 250000 # number of events = size of training set
